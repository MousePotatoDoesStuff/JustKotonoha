...
init python:
    ...
    # the game launches.
    XL=['' for i in range(100)]
    for e in LX:
        XL[e[1]]=e[0]
    splash_message_default = 'Mod development team:\n'+'\n'.join([e for e in XL if e!=''])
...
image menu_art_k:
    subpixel True
    "kotonoha toward casual happ ce cm"
    xcenter 700
    ycenter 500
    zoom 0.90
    menu_art_move(0.68, 510, 0.68)
...
label splashscreen:
    ...
    if renpy.random.randint(0, 100) == 0:
        $ splash_message = "Why did you do this to me?"
